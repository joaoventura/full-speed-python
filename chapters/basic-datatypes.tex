...
Using the Python documentation on strings (\url{https://docs.python.org/3/library/stdtypes.html?highlight=rfind#text-sequence-type-str}), solve the following exercises:
